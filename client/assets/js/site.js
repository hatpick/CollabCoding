...
function editor(id, mode) {
  _editor = CodeMirror.fromTextArea(id, {
    mode : mode,
    lineNumbers : true,
    lineWrapping : true,
    extraKeys : {
...
$(document).ready(function() {       
  ...
  $("#doc-tab li.active a").attr('data-docId', docName);
      ...
      buttons: [
        {
          ...
          click: function() {
           ...
           _docId =  randomDocName();
           _fileName = $('div input').val();
           _tab_link = $('<a>').attr({href: "#div-" + _fileName, 'data-docId': _docId}).text(_fileName).click(function(e) {
               e.preventDefault();
                $(this).tab('show'); 
            });
           ...
           _div_textarea = $('<div>').addClass('tab-pane fade').attr('id', 'div-'+_fileName).append($('<textarea>').attr('id', _fileName));
