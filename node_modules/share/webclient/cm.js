(function() {
    ...
    getAugmentedText = function(pname, sharejs_document_text, editor) {
                                
    };

    window.sharejs.Doc.prototype.attach_codemirror = function(editor, pname, sid, keepEditorContents) {
        ...
        if (keepEditorContents) {
            ...
            var url = '/project/' + pname + '/' + sid + '/loadXML';
            var latest;                                                        
